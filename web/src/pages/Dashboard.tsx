   ...
   >
    ...
    <div className="space-y-2 mb-3">
     <div className="flex items-center gap-3">
      <span className="text-xs text-gray-400 w-9 shrink-0">Uptime</span>
      <span className="text-xs text-gray-300 flex-1 text-right tabular-nums">{formatUptime(uptimeS) || '--'}</span>
     </div>
     <div className="flex items-center gap-3">
